# Mango Defect Detection System

This repository contains a deep-learning-based fruit defect detection system focused on mango quality inspection. It includes model training code, a FastAPI inference service, a React frontend, the dataset used by the project, and preserved detection outputs.
...
- `train.py`: training entry for the YOLOv8 mango defect detector
...
- `runs/`: preserved model weights and training/validation outputs
